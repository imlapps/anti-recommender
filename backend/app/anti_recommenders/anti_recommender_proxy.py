...
class AntiRecommenderProxy(AntiRecommender):
    ...
    def generate_anti_recommendations(self, type: str = "openai") -> Tuple[Tuple[str, ...], ...]:
        ...
        return self.anti_recommender.generate_anti_recommendations(self.__wikipedia_title)
